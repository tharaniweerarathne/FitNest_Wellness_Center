...
<body>
  ...
  <div class="sidebar">
    ...
    <ul>
    <li><a href="staffDashboard.php" ><i class="ri-home-4-line"></i> Dashboard</a></li>
      <li><a href="feedbackReply_staff.php" class="active"><i class="ri-feedback-line"></i> Feedback Reply</a></li>
